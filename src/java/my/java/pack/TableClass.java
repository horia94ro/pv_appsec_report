...
public class TableClass {
    ...
    public String getFormattedTable() {
        ...
        try {
            ...
            ResultSet db_rs = db_statement.executeQuery("select * from RestAPI where BUILD='"+this.table+"' ORDER BY PLATFORM, ID ASC");
    ...
    public String getFormattedTableUi() {
        ...
        try {
            // Connect to DataBase
            Class.forName("com.mysql.jdbc.Driver").newInstance();
            Connection db_con = DriverManager.getConnection("jdbc:mysql://localhost:3306/appsec_pv_auto_report","cstanuica","spirent");
            
            // Execute Query
            Statement db_statement = db_con.createStatement();
            ResultSet db_rs = db_statement.executeQuery("select * from UI where BUILD='"+this.tableui+"' ORDER BY PLATFORM, ID ASC");
